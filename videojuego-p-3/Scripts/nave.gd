...
@export_group("Sonido")
@export var sfx_victoria: AudioStream = preload("res://Sounds/SFX/AlienSound.mp3")

@onready var canvas_victoria: CanvasLayer = $CanvasVictoria
@onready var etiqueta_tiempo: Label = $CanvasVictoria/EtiquetaTiempo
@onready var boton_reintentar: BaseButton = $CanvasVictoria/BotonReintentar
@onready var boton_menu: BaseButton = $CanvasVictoria/BotonSalir
...
func _ready() -> void:
	...
	sonido_victoria.stream = sfx_victoria
